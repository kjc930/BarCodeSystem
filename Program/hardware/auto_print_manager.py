...
class AutoPrintManager(QObject):
    ...
    def generate_hkmc_barcode(self, process_part, child_parts_scanned):
        ...
        try:
            ...
            # ASCII 코드 추가 (HKMC 규격) - 샘플 형식
            process_hkmc_ascii = f"[)>_1E06_1DV{supplier_code}_1DP{part_number}_1DS{sequence_code}_1DE{eo_number}_1DT{traceability_code}{serial_type}{tracking_number}_1DM{initial_mark}_1D_1E_04"
            ...
            for child_data in child_parts_scanned:
                ...
                if child_part_number:
                    ...
                    # ASCII 코드 추가 (HKMC 규격) - 샘플 형식
                    child_hkmc_ascii = f"[)>_1E06_1DV{supplier_code}_1DP{child_part_number}_1DS{sequence_code}_1DE{eo_number}_1DT{traceability_code}{serial_type}{tracking_number}_1DM{initial_mark}_1D_1E_04"
